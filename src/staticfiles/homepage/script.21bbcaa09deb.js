...
$(document).ready(function () {
  ...
  jsonData.forEach(project => {
    ...
    project_wrapper.innerHTML =
      ...
      project.link ? `<a class="btn btn-success" href=${project.link} target=_blank` : ''+
      project.github_link ? `<a class="btn btn-success" href=${project.github_link} target=_blank` : ''+
